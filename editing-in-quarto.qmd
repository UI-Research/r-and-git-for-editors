...
::: urban-ordered-list
 1. Open RStudio and install a LaTeX distribution. When using LaTeX in  
 2. Write the Document
    i) Content is typically in plain text in a .tex file and includes commands to format text. See the example below:
...
3. Run a LaTeX compiler program that reads the .tex file and processes it to produce a formatted PDF. The output is a clean, professional-looking document where all elements are perfectly placed, consistent, and properly formatted.
...
For more information on the basics of R use at Urban, click [here](https://urbaninstitute.github.io/r-at-urban/intro-to-r.html). See @box-about for more information.
