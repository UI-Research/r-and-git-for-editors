...
To change capitalization, hyphenation, or other text changes in legend and axis text, look at the example code again, this time with the proper text highlighted. 
...
To change data labels,

#### Low-quality exported images

If the images in a report generated in R are not high-enough quality for print publications, you can change the parameters by using the following code:
...
One you have made the appropriate changes, you can export the file using the following code. Make sure the resolution is good enough for print publications (the resolution below should work).
